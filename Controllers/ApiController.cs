...
namespace Moodify.Controllers
{
    ...
    public class ApiController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<List<Track>>> Get(string songTitle, string artistName, int? userId)
        {
            var allSongs = _database.GetAllSongTitles();
            ...
            HttpResponseMessage response = await _httpClient.GetAsync(requestUrl);
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    songModels = trackList.Select(track => new Track
                    {
